...
async function bundle() {
    ...
    for (let file of files) {
        ...
        try {
            ...
            fileWriting.push(outputFile(fileNameWithoutExtension + extensions.js, validator));
            
            // typescript bindings
            const typeBindings = await compile(bundledSchema as any, fileNameWithoutExtension);
            fileWriting.push(outputFile(fileNameWithoutExtension + extensions.ts, typeBindings));
        } catch (e) {
